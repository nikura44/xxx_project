package com.xxx_project.common.config;
...
@Configuration
@MapperScan(basePackages = "com.xxx_project.mapper", sqlSessionTemplateRef = "commonSqlSessionTemplate")
...
public class CommonDataSourceConfig {
    ...
    @Bean
    public PlatformTransactionManager transactionManager(@Qualifier("commonDataSource") DataSource commonDataSource) {
    ...
    public DataSourceTransactionManager transactionManager2(@Qualifier("commonDataSource") DataSource dataSource) {
